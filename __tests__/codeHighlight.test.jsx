...
const expectation = "<pre><code class='text-amber-700'> <span class='text-gray-500'>(</span>a<span class='text-gray-500'>)</span> <span class='text-brand-maroon'>=></span> a + 1<span class='text-gray-500'>;</span>"
...
const expectation2 = "<pre><code class='text-amber-700'> return <span class='text-gray-500'>// abc</span> </code></pre>"
